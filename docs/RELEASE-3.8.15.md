...
- treat non-success GitHub issue-create acknowledgements as ambiguous and reconcile before any retry;
- paginate GitHub idempotency-marker lookup so existing effects beyond the first 100 issues remain discoverable.
