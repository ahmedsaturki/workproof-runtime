...
## Release ordering and regression record

v3.8.3 was published only after the matching Container workflow completed successfully. v3.8.2 is retained as historical provenance but is superseded and is not a rollback target.
