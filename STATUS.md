...
- scheduled post-release integrity health: added to CI; it revalidates the current main/release lineage, downloads and SHA256-checks all published release assets, validates release manifest and benchmark semantics, verifies rollback release/tag/container lineage, and reruns source-tree/secret/container-base checks
