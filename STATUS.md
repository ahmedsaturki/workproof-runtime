...
**v3.4 benchmark is verified; v3.4.0-dev.6 is the current coherent distribution target.**

Latest main: the current branch head; see the GitHub ref and the latest CI run for the exact commit SHA.

Since the release target `c1c1f378d0e79acfc4ee22d5d2ca3fa389e8402d`, main has added distribution hardening, documentation corrections, and deterministic persistent-lease test hardening. The v3.4.0-dev.6 source release is pinned to the release tag commit.
...
- [x] v3.4.0-dev.6 GHCR image publication and smoke
- [x] v3.4.0-dev.6 GitHub Release publication and re-download verification
