...
const required = [
  ...
  "docs/RELEASE-GATE-V3.5.md",
  "docs/RELEASE-GATE-V3.6.md",
  ...
  "examples/missions/research-a2a-ready.json",
  ...
  "packages/evidence/src/portable.ts",
  "packages/evidence/src/compatibility.ts",
  ...
  "packages/telemetry/src/otel.ts",
