# WorkProof Runtime Specification - v3.8.12

## Current v3.8.12 baseline

The current stable product specification is maintained at v3.8.12. The v3.4 sections below remain historical acceptance records and are not the current release status.
